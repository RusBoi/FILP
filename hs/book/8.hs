...
tellPerson (Person {firstName = n, lastName = n1, age = a, height = h}) = "His name is " ++ n
...
data Day = Monday | Tuesday | Wednesday | Thursday | Friday | Saturday | Sunday  deriving (Eq, Ord, Read, Show, Bounded, Enum)
...
-- data List a = Empty | Cons {listHead :: a, listTail :: a} deriving (Show, Read, Eq, Ord)
